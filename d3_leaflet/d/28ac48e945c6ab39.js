// https://observablehq.com/@diegofarias06/d3-com-crossfilter-e-dc-js-parte-3@266
export default function define(runtime, observer) {
  const main = runtime.module();
  main.variable(observer()).define(["md"], function(md){return(
md`# D3 com Crossfilter e DC.js (Parte 3)`
)});
...
facts.dimension( d => d.magnitude)
  ...
  main.variable(observer("magGroup")).define("magGroup", ["magDim"], function(magDim){return(
magDim.group()
)});
...
hourDim.group()
  ...
  main.variable(observer("buildvis")).define("buildvis", ["md","container","dc","dateDimension","d3","magDim","width","magGroup","depthDim","depthGroup","dataset","terremotoByHour"], function(md,container,dc,dateDimension,d3,magDim,width,magGroup,depthDim,depthGroup,dataset,terremotoByHour)
{
  ...
  let timeChart = dc.lineChart(view.querySelector("#time-chart"))
  timeChart.width(960)
           .height(150)
           .dimension(depthDim)
           .x(d3.scaleTime()
