...
md`# Taxa de desemprego nos EUA em agosto de 2016`
  ...
  main.variable(observer("buildvis")).define("buildvis", ["d3","DOM","topojson","us","dgreens","rateById"], function(d3,DOM,topojson,us,dgreens,rateById)
{
  const width = 960
  const height = 600
  ...
  svg.append("g")
    ...
    .enter().append("path")
      ...
      .text(d => "id: " + d.id + " taxa: " + rateById.get(d.id))
...
d3.tsv("https://gist.githubusercontent.com/emanueles/7fbdcd8ee412e3e63904114cf9d7ee3a/raw/af4fd93db1be3f9033caff46d4a574a54bf9363f/unemployment.tsv").then(function (data) {
  ...
  main.variable(observer("dgreens")).define("dgreens", ["d3"], function(d3){return(
